        ...
        <div class="layout-px-spacing">
            ...
            <div id="basic" class="col-lg-12 mt-4 layout-spacing">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="simple-example" action="add-sub-Category.inc.php" method="POST">
                            <div class="form-row">
                            ...
                            <button class="btn btn-primary submit-fn mt-2" name="submit" type="submit">Add Brand</button>
                        </form>
                    </div>
                </div>
            </div>
