            ...
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <form id="location_form" action="defult.inc.php" method="POST" class="p-4">
                    ...
                    <div class="locationTable p-5">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <?php
                                $stmt = $con->prepare("SELECT * FROM `locationw`");
                                $stmt->execute();
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td></button><a href="update_location.php?l_id=<?php echo $location['id']; ?>" class="btn btn-info btn-sm">Update</a></td>
                                        </td>
                                        <td></button><a href="delet_location.inc.php?l_id=<?php echo $location['id']; ?>" class="btn btn-danger btn-sm">Delete</a></td>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
