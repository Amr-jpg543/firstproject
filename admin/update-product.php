            ...
            <div class="row mt-4">
                <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="update-product.inc.php?id=?id=<?php echo $row4['id']; ?>" method="POST" enctype="multipart/form-data">

                                <div class="form-row mb-4">
                                    <div class="form-group col-md-6">
                                        <label for="category">Category</label>
                                        <select class="form-control" name="category" id="category">
                                            <option value="<?php echo $row4['id']; ?>" selected>Select Category</option>
...
?>">--SELECT--</option>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="p_name" value="<?php echo $row4['p_name'] ?>" require class="form-control" id="tittle" placeholder="Enter Your Product Name">
                                </div>
                                <!-- <div class="form-group mb-4">
                                    <label for="inputAddress2">Specification Of Product </label>
                                    <textarea name="p_description" class="form-control" cols="30" rows="4"><?php echo $row4['p_description'] ?></textarea>
                                </div> -->
                                <div class="form-p_row mb-4">
                                    <div class="form-group col-md-4">
                                        <label for="inputCity">Discount Price</label>
                                        <input type="number" name="p_discount" value="<?php echo $row4['p_discount'] ?>" placeholder="Example : 50000" class="form-control" id="inputCity" require>
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label for="inputCity">Product Price</label>
                                        <input type="number" name="p_price" value="<?php echo $row4['p_price'] ?>" class="form-control" placeholder="Example : 20000" id="inputCity" require>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputState">Quantity</label>
                                        <input type="number" name="p_quantity" value="<?php echo $row4['quantity'] ?>" class="form-control" placeholder="Example : 100" id="inputCity" max="200" min="0" require>

                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputZip">Choose Color</label>
                                        <select class="form-control" name="p_color" id="">
                                            <option value="<?php echo $row4['p_colour'] ?>"><?php echo $row4['p_colour'] ?></option>
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="file" value="<?php echo $row4['images'] ?>" multiple name="image" class="form-control" id="inputZip">
                                    </div>
                                </div>
