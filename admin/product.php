                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <img width="100" height="100" src="../uploads/<?php echo $row['images']; ?>" alt="img" class="profile-img">
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a href="update-product.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Update</a>
                                                <a href="product_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
