									...
									<div class="cart-dropdown">
										<div class="cart-list">
											...
											foreach ($result as $row) {
												...
												$product_price = $a['p_price'];
												$product_qty = $row['p_qty'];
												$total = $product_price * $product_qty;
												$cart_total = $cart_total + ($a['p_price'] * $row['p_qty']);
											...
											?>
												<div class="product-widget">
													...
													<div class="product-body">
														<h3 class="product-name"><a href="product.php?p_id=<?php echo $row['id'] ?>"><?php echo $a['p_name'] ?></a></h3>
														<h4 class="product-price"><span class="qty"><?php echo $row['p_qty'] ?>x</span><?php echo $a['p_price'] ?> = <?php echo $total; ?></h4>
													</div>
